<template>
    <div id="app" style="padding-bottom: 300px;">
        ...
        <textarea  style="height:300px; width:100%;" v-html="data"></textarea>
                </div>
            </div>
        </div>
        ...
        <textarea  style="height:300px; width:100%;" v-html="asyncData">
        </textarea>
                </div>
            </div>
        </div>
        ...
        <div>
            <div style="width:840px; margin: 0 auto;">
                ...
                <div style="width:50%; display:inline-block;">
        <textarea  style="height:300px; width:100%;" v-html="data">
        </textarea>
                </div>
            </div>
        </div>
        ...
        <div>
            <div style="width:840px; margin: 0 auto;">
                ...
                <div style="width:50%; display:inline-block;">
                    <textarea  style="height:300px; width:100%;" v-html="data3">
                    </textarea>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            itemDropBefore (node, item, draggedItem , e) { e;
                if (!draggedItem) {
                    item.addChild({
                        text: "newNode",
                        value: "newNode"
